...
namespace Asteroids
{
    ...
    public class Ship : BaseObject, ICollision
    {
        ...
        public void Move(KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Up && _pos.Y >= 0)
            {
                _dir.Y = -1;
            }
            
            if (e.KeyCode == Keys.Down && _pos.Y <= GameGraphics.Height - _size.Height)
            {
                _dir.Y = 1;
            }
        ...
        public override void Update()
        {
            ...
            _pos.Y = Util.Clamp(_pos.Y, GameGraphics.Height - _size.Height, 0);
           
            SetColliderSizeAndPos(0.9f);
